...
const STATIC_CODE_STYLE_URL = "/static/codestyle.css"  // Static URL of css for code styling
const MDX_ROOT_DIRECTORY = "./"  // path to mdx root directory, relative to this file's location
const SITE_GUIDE_PATH = "../static/siteguide.json"  // path to site guide, relative to this file's location
