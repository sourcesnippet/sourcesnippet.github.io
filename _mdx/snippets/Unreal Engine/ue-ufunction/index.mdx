import { HTMLSkeleton, H1, H2, Img } from "./global.jsx"

export const snippet_title = "UFunction in Unreal Engine C++"
...
```cpp
UFUNCTION(BlueprintCallable, Category="Custom Category", meta=(DisplayName="My Custom Function"))
...
```
<img width={"40%"} src="/_static/ue-blueprintImplementable-function-screenshot.png"/>
