...
export const snippet_title = "UProperty in Unreal Engine C++"
...
```cpp
UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Custom Category", meta=(DisplayName="My Custom Property"))
