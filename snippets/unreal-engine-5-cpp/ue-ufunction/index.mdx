...
DefaultToSelf = "MyParameterName"  // In Blueprint this defaults the value of given input parameter to self
```

<br/>

## References:
1. [Epic Documentation - UFunctions](https://dev.epicgames.com/documentation/en-us/unreal-engine/ufunctions-in-unreal-engine)
1. [Unreal Garden - All UFUNCTION Specifiers](https://unreal-garden.com/docs/ufunction/)
