...
class MYPROJECT_API IExampleInterface
{
    ...
    public:
       ...
       void MyExample();  // or void MyExample() = 0; To mark as pure virtual function i.e. Forcing every child class to implement it otherwise a compilation error is thrown
