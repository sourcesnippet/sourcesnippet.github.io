...
Instanced  // Makes sure that the (UObject dervied) property is a unique copy, More info below

Transient  // Resets property value to default after reopen the editor
...
Example of `Instanced` specifier <a href={UE_EDIT_OBJECT_IN_EDITOR_URL}>here</a>
...
## References:
1. [Epic Documentation - UProperties](https://dev.epicgames.com/documentation/en-us/unreal-engine/unreal-engine-uproperties)
1. [Unreal Garden - All UPROPERTY Specifiers](https://unreal-garden.com/docs/uproperty/)
